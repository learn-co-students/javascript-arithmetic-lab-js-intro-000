...
/*
subtract(a, b) subtracts b from a and returns the results
*/
...
/*
preserveDecimal(n) preserves n's decimals (it parses n as a floating point
number) and returns the parsed number
